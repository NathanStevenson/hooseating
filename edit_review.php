<?php 
    ...
    define('REVIEW_ID', intval($_GET['review_id']));
        ...
        <form method="post" class=" shadow w-50 mx-auto border border-secondary border-3 rounded-3 mt-2" style="background-color: white;">
            <div class='mx-3 my-4'>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="rating" name="rating" min="0" max="10" step="0.01" value=<?php echo $review_data[0]['rating']; ?>>
                </div>
